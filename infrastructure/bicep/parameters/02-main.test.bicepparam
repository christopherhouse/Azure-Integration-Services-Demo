...
param virtualNetworkName = 'bw-ais-test-vnet'
...
param keyVaultName = 'bw-ais-test-kv'
param logAnalyticsWorkspaceName = 'bw-ais-test-laws'
...
param appServicePlans = [
  {
    ...
    instanceCount: 1
    zones: ['1']
    resourceGroupName: 'BW-AIS-CUSTSVC-TEST'
    tags: {
